...
public class StratosV400MockServelet extends HttpServlet {
    ...
    public static final String AUTOSCALE_POLICY_LIST_CONTEXT_PATH = "/partition";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (AUTOSCALE_POLICY_LIST_CONTEXT_PATH.equals(req.getPathInfo())) {
            ...
            log.info("Server sent response: " + str);
        }
    }
